...
struct RingMeasurementModel {
    ...
    static func createStubModel() -> Self {
        RingMeasurementModel(
            ...
            onboardingTexts: ["Расположите кольцо так, чтобы внутри был красный круг", "Отрегулируйте размер красного круга так, чтобы он занял все внутреннее пространство кольца", "Приложите палец на красную линию и отрегулируйте красную область по самому широкому местуПриложите палец на красную линию и отрегулируйте красную область по самому широкому местуПриложите палец на красную линию и отрегулируйте красную область по самому широкому месту"],
            size: 18,
            sizeStep: 0.5,
            onboardingStep: 0,
